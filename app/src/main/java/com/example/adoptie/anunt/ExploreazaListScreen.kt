...
import com.example.adoptie.ui.components.AppSearchField
import com.example.adoptie.ui.components.EmptyState
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        Row(
            ...
            FilledTonalButton(
                ...
                Icon(Icons.Default.List, contentDescription = "Filtre")
        ...
        PullToRefreshBox(
            ...
            when (val state = anunturiState) {
                ...
                is AnunturiState.Success -> {
                    ...
                    if (filteredAndSortedAnunturi.isEmpty()) {
                        Box(
                            modifier = Modifier
                                .fillMaxSize()
                            ...
                            EmptyState(
                                title = if (searchQuery.isNotEmpty()) "Niciun rezultat" else "Niciun anunț",
                                message = if (searchQuery.isNotEmpty()) {
                                    "Încearcă alți termeni de căutare sau schimbă filtrele."
                                } else {
                                    "Nu există anunțuri active momentan. Revino mai târziu!"
                                }
                            )
                        }
                    } else {
